...
<font size="5">
    ...
    <span class="icon-fct-unl" title="3D Object Modelling Demo for a flying Helicopter, using WebGL (FCT NOVA - December 2017)">
	        		<span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4">
				</span>
	    		</span>
...
<p align="justify"><font size="2"><a target="_blank" href="/projects/webgl/3d-object-modelling-helicopter/3d-object-modelling-helicopter-demo.html" title="3D Object Modelling Demo for a flying Helicopter, using WebGL (FCT NOVA - December 2017)">A <i>3rd year's project</i>, of the <i>BSc. degree</i> made in <i>FCT NOVA</i>, in the subject of <i>Computer Graphics and Interfaces</i>. This project was built using <i>HTML</i>, <i>CSS</i>, <i>JavaScript</i> and <i>WebGL</i>. The application allows to drive a flying <i>Helicopter</i> above a city, all using <i>3D Modelling and 3D Objects</i>. The <i>Helicopter</i> it's drived using the keyboard and you can see all the action of multiple angles, using an <i>Axonometric Projection</i>! </a></font></p>
