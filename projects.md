...
<font size="2">
    <p align="justify">
        ...
        <br>
            c) Choose the current <b><i>Fractal's Set</i></b> in use (<i>Benoit Mandelbrot</i> or <i>Gaston Julia</i>);
        <br>
            d) Choose also the current <i>Factor</i> to the <i>Scale</i> of the current <b><i>Fractal</i></b> in use;
    </p>
</font>    
