...
<h2 id="myinfo"><i>My Info</i><i class="fa fa-circle-thin fa-stack-2x" style="font-size:36px;color:Black"></i><i class="fa fa-info fa-stack-1x fa-spin" title="My Info" style="font-size:20px;color:Black"></i></h2>
<hr/>
