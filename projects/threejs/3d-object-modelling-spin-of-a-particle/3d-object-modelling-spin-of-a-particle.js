    ...
    if(intersects.length > 0) {
        ...
        if(intersects[0].object != SPIN_DOWN_INTERSECTED) {
            ...
            if(quantum_state_of_spins == 2) {
                ...
                document.getElementById("object_name").innerHTML = (intersects[0].object.parent[ (particle_spin_down_property_keys.length + particle_spin_down_superposition_property_keys)[0] ])[0];
